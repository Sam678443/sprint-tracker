...
class SprintsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sprint" do
    assert_difference("Sprint.count") do
      post sprints_url, params: { sprint: { bpm: @sprint.bpm, jogging: @sprint.jogging, name: @sprint.name, sittingbpm: @sprint.sittingbpm, sprintingbpm: @sprint.sprintingbpm, warmup: @sprint.warmup } }
    end
  ...
  test "should update sprint" do
    patch sprint_url(@sprint), params: { sprint: { bpm: @sprint.bpm, jogging: @sprint.jogging, name: @sprint.name, sittingbpm: @sprint.sittingbpm, sprintingbpm: @sprint.sprintingbpm, warmup: @sprint.warmup } }
